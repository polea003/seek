    ...
    <div className="flex flex-col space-y-24">
      <div className="flex flex-col items-center">
        <div className="mb-20 flex flex-col items-center">
          <div className="text-4xl sm:text-6xl md:text-8xl font-thin tracking-wide text-center">
        ...
        <div className="w-72 h-64 sm:w-[600px] sm:h-[450px] lg:w-[800px] lg:h-[500px] relative rounded-xl overflow-hidden">
          <Image
        ...
        <div className="flex flex-col lg:flex-row gap-20 mt-16 text-lg sm:text-xl lg:text-justify">
        ...
        <div className="font-thin text-4xl sm:text-5xl mt-20 tracking-wide">Meet The Team</div>
        <div className="w-full flex flex-col md:flex-row items-center mt-12 gap-8">
